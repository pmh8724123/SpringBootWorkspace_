...
public class MenuController {
	 ...
	 *  - 서버에 존재하는 모든 데이터(문서, 이미지, 사용자정보 등)을 의미한다.
	 ...
	 *  - REST방식을 사용하면 URI와 HTTP메서드만 확인 시 어떤 기능을 하는지 쉽게 알 수 있다.
	 * 
	 * #2. Rest API
	 ...
	 * */
	@GetMapping("/menus")
	@Operation(summary = "메뉴목록 조회", description = "메뉴목록 조회. type과 taste로 필터링 가능")
